...
// IMPORTANT: specific named routes BEFORE the {id} wildcard
...
Route::get('/booked-slots', [BlockedSlotController::class, 'unavailableSlots']);
Route::get('/unavailable-slots', [BlockedSlotController::class, 'unavailableSlots']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    */
    ...
    |--------------------------------------------------------------------------
    | CONSULTATIONS
    | IMPORTANT: named/specific routes BEFORE wildcard {id} routes
    |--------------------------------------------------------------------------
    */

    Route::get('/admin/consultations', [ConsultationController::class, 'index']);

    // IMPORTANT: these must come BEFORE /consultations/{id}
    ...
    */
    ...
    // IMPORTANT: specific route BEFORE the {id} wildcard
